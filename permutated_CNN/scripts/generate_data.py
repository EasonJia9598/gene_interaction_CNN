...
def main():
    ...
    print("############################################################################")
    data_generation(directory, profile_file_name_pattern, rates_file_name_pattern, number_of_profiles_in_one_gene_image_array, generatin_type, cut_off_files, total_files_to_convert, gene_image_type)
